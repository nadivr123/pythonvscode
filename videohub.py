...
if menu == "Video Ratings":
    ...
    melt_tables = viewcounts.melt(var_name= 'Video Title',value_name= 'Number of Views')

    barchart = px.bar(melt_tables, x='Video Title', y= 'Number of Views')
    barchart.update_layout(xaxis=dict(showtickabels=False))
    st.plotly_chart(barchart)
    piechart = px.pie(names='Video Title',values='Number of Views')
